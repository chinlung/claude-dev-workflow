          ...
          crossReferences: {
            ...
            items: {
              ...
              properties: {
                ...
                quotedCode: { type: 'string', minLength: 1, description: 'verbatim code excerpt confirming the finding location' },
                note: { type: 'string', minLength: 1 },
              },
              required: ['file', 'lines', 'quotedCode', 'note'],
            },
          },
        },
        required: ['id', 'file', 'line', 'summary', 'severity', 'confidence', 'claim', 'evidence', 'failureScenario', 'crossReferences'],
      },
    },
  },
  required: ['findings'],
    ...
    crossReferences: {
      ...
      items: {
        ...
        properties: {
          file: { type: 'string', minLength: 1 },
          lines: { type: 'string', minLength: 1 },
          quotedCode: { type: 'string', minLength: 1, description: 'verbatim code excerpt supporting the verdict' },
          note: { type: 'string', minLength: 1 },
        },
        required: ['file', 'lines', 'quotedCode', 'note'],
      },
