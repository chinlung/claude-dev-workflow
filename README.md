...
This validates every valid fixture exits 0 and every invalid fixture exits non-zero across all plugins (119 fixture checks, including generated single-field mutation checks, no install required).
